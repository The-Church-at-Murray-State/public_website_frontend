          ...
          <div className="grid grid-cols-1 gap-16">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto items-start">
                {/* Left column as a single grid so icon/text tracks align to the widest text */}
                <div className="grid grid-cols-[3rem_minmax(0,1fr)] md:grid-cols-[3rem_max-content] gap-x-4 gap-y-8 items-start w-full md:w-fit md:justify-self-start">
                ...
                {/* Right column as a single grid; right-aligned and sized to longest line */}
                <div className="grid grid-cols-[3rem_minmax(0,1fr)] md:grid-cols-[3rem_max-content] gap-x-4 gap-y-8 items-start w-full md:w-fit md:justify-self-end">
                  <div className="flex-shrink-0 bg-church-gold text-white p-3 rounded-lg w-12 h-12 grid place-items-center">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
